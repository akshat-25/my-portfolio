...
function Contact() {
  ...
  return (
    <div
      name="contact"
      className="bg-gradient-to-b from-slate-800 to-black md:h-screen text-white h-screen w-screen"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-screen h-full">
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 border-gray-500">
            Contact
          </p>

          <div class="sm:h-70 bg-white p-6 rounded-lg shadow-lg mt-10 md:flex md:flex-row justify-evenly shadow-gray-200 flex flex-col h-70 place-items-center">
